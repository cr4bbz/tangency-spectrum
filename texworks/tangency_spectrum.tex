...
\begin{figure}[htbp]
 ...
 abzählbar viele kontrahierende Rückkehrzweige. Die im Bild notierte
 Schwanzordnung ist die konkrete zu überprüfende geometrische
 Abschätzung.}
 \label{fig:apollonian-induction}
\end{figure}

\begin{question}[Apollonische Rückkehrhypothese]
Lassen sich für $\theta\in[\sqrt2,q]$ gleichmäßig
\[
 \tau_{\theta,m}\asymp m,
 \qquad
 \|T_{\theta,m}'\|_\infty\asymp(m+1)^{-2}
 \qquad(m\ge1)
\]
zeigen, zusammen mit einer einheitlichen Verzerrungsabschätzung für
Kompositionen?
\end{question}

Unter dieser Hypothese besitzt der gewichtete induzierte Operator
\[
...
Angenommen, die Apollonische Rückkehrhypothese gilt und der führende
...
\begin{proof}
Die Rückkehrhypothese liefert bei $s=\delta>1$
\[
